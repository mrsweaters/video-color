...
var CanvasVideo = function(video, sx, sy, sw, sh, dx, dy, dw, dh){
...
CanvasVideo.prototype.clear = function() {
  this.context.clearRect(0, 0, this.width, this.height);
}

CanvasVideo.prototype.update = function(imageData) {
  this.context.putImageData(imageData, 0, 0);
}

CanvasVideo.prototype.getPixelCount = function() {
  return this.width * this.height;
}

CanvasVideo.prototype.getImageData = function() {
  return this.context.getImageData(0, 0, this.width, this.height);
}

CanvasVideo.prototype.removeCanvas = function() {
  $(this.canvas).remove();
}
...
*/
function getDominantColor(sourceVideo, sx, sy, sw, sh, dx, dy, dw, dh){

  var palette = [];

  // Create custom CanvasVideo object
  var image = new CanvasVideo(sourceVideo, sx, sy, sw, sh, dx, dy, dw, dh),
...
function createPalette(sourceImage, colorCount){
  ...
  // Create custom CanvasVideo object
  var image = new CanvasVideo(sourceImage),
    imageData = image.getImageData(),
    pixels = imageData.data,
    pixelCount = image.getPixelCount();
